...
<div class="login-box">
  <div class="login-logo">
    <h1 id='head-login' style="font-weight: bold;">Welcome You At <br>Victiny Health Care <br>Reporting App</h1>
  </div>
  <!-- /.login-logo -->
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url(); ?>User/login_validation" class="login-form" method="post">
