...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-bold">Victiny App</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <!--  <li class="nav-item">
            <a href="<?php echo base_url()?>Admin/manage_user" class="nav-link">
		  ...
		  <li class="nav-item">
            <a href="<?php echo base_url()?>Admin/manage_doctor" class="nav-link">
              <i class="nav-icon fas fa-user"></i>
              <p>
              Doctor Management
              </p>
		  ...
		  <li class="nav-item">
            <a href="<?php echo base_url()?>Admin/manage_area" class="nav-link">
              <i class="nav-icon fas fa-user"></i>
              <p>
              Area Management
              </p>
		  ...
		  <li class="nav-item">
            <a href="<?php echo base_url()?>Admin/manage_products" class="nav-link">
              <i class="nav-icon fas fa-user"></i>
              <p>
              Product Management
              </p>
		  ...
		  <li class="nav-item">
            <a href="<?php echo base_url()?>Admin/manage_promoItems" class="nav-link">
              <i class="nav-icon fas fa-user"></i>
              <p>
